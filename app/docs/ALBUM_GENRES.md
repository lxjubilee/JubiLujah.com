...
How every album on JubileePraise.com gets a **Primary** and **Secondary** music-style
...
Each album folder under `<ARTWORK_BASE>/<album.path>/` (default `J:/jubileepraise.com/music/...`)
...
ARTWORK_BASE=J:/jubileepraise.com/music node scripts/gen-album-genres.mjs JEIM1069EN,SAIM1001EN
...
ARTWORK_BASE=J:/jubileepraise.com/music node scripts/verify-genres.mjs
```

**Adding a new album:** drop its folder (with `blueprint.md` + lyrics) under
`J:/jubileepraise.com/music/...`, ensure it's in the manifest, then run steps 1–2. Its genres are
