...
const OUT = 'C:/Users/MELODY~1.INS/AppData/Local/Temp/claude/w--JubileePraise-com/ec7103b0-63ad-4a95-aa19-bd776d58fc35/tasks/wgt71ru8e.output';
...
const rows = res.rows || [];
fs.writeFileSync('w:/JubileePraise.com/app/_ratings-work/report-rows.json', JSON.stringify(rows));
...
const processed = new Set(JSON.parse(fs.readFileSync('w:/JubileePraise.com/app/_ratings-work/santiago-lyrics-files.json','utf8')).map(x => x.lyricsPath.toLowerCase()));
const root = 'J:/jubileepraise.com/music/inspire/santiago-inspire';
...
fs.writeFileSync('w:/JubileePraise.com/app/_ratings-work/santiago-unprocessed.json', JSON.stringify(unprocessed));
