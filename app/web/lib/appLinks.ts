...
// JubiLujah app identifiers. The Apple Team ID and Android SHA-256 fingerprint are
...
export interface AppLinks {
  ...
  scheme: string; // custom URL scheme the app registers, e.g. jubilujah://
}

export function getAppLinks(): AppLinks {
  return {
    ios: {
      bundleId: process.env.IOS_BUNDLE_ID || 'com.jubilujah.app',
      appStoreUrl: process.env.IOS_APP_STORE_URL || 'https://apps.apple.com/us/app/jubilujah/id6781227388',
      appleTeamId: process.env.APPLE_TEAM_ID || 'G7MXS3Q274',
    },
    android: {
      packageName: process.env.ANDROID_PACKAGE || 'com.jubilujah.app',
      playStoreUrl: process.env.ANDROID_PLAY_STORE_URL || 'https://play.google.com/store/apps/details?id=com.jubilujah.app',
    ...
    scheme: process.env.APP_SCHEME || 'jubilujah',
  };
}
