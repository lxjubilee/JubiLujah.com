...
**File:** `setup/generatelyrics-jubileepraise.md`
**Purpose:** Everything required to reproduce the JubileePraise / Jubilee Inspire Family music-lyrics
...
`W:\JubileePraise.com\.prompts\music_albums (Part 1) - blueprints.md` ·
...
`J:\jubileepraise.com\music\inspire\*\_protocol\` — `amir-build-protocol.md`,
